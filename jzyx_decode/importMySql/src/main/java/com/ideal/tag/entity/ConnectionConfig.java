...
public class ConnectionConfig {
	...
	public ConnectionConfig(String ip, String port, String username, String pass, String url) {
		super();
		this.ip = ip;
		this.port = port;
		this.username = username;
	...
	public static ConnectionConfig from() {
		...
		try{
			...
			String url="jdbc:mysql://"+ip+":"+port+"/jzyx?useUnicode=true&characterEncoding=UTF-8";
			config = new ConnectionConfig(ip, port, username, pass, url);
		}catch(Exception e){
