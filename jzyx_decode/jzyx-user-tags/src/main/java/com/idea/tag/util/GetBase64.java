...
public class GetBase64 extends Configured implements Tool{
	/**
	 * 临时工具类
	 * 
	 * */
	private static final Log LOG = LogFactory.getLog(GetBase64.class);
...
//		conf.set("fs.defaultFS", "hdfs://localhost:9000");
		Job job = Job.getInstance(conf,"get base64");
		job.setJarByClass(GetBase64.class);
	...
	public static void main(String[] arg0) throws Exception {
	    ...
	    System.exit(ToolRunner.run(new Configuration(), new GetBase64(), arg));
	}
}
